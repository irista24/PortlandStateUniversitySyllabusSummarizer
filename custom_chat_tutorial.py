...
train_directory = '/u/irist_guest/Desktop/app/train_files/'
...
# create embeddings
embeddings = OpenAIEmbeddings(openai_api_key = "sk-proj-ntDWVfI5zdQaRZlQGWrqT3BlbkFJViad61TGOieDweHkKRcQ")
